...
<head>
  ...
  <link rel="stylesheet" href="bower_components/bootstrap/dist/css/custom_style.css">
...
<div class="pad_bannerH">
	<img src="img/bannHeader.jpg" alt="" />	
</div>

<div class="wrapper">

  <!-- Main Header -->
  <header class="main-header bg_colorNav">
...
<!-- แสดง รูปuser และชื่อที่ดึงมาจาก mis -->
...
(async () => {
  ...
  //
  $("#dvMain").load("/NRRUBooking/chooseMenu.php");
  }
