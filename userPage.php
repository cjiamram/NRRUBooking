...
<!--<div class="wrapper" style="background:url('img/Bg2.jpg');background: -webkit-linear-gradient(to bottom, #459502, #67A800);">
  <img src='img/Header.jpg' style='height:150px'>
</div>-->
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="#" class="logo">
      <span class="logo-mini"><b>NBK</b></span>
      <span class="logo-lg"><b>NRRU Booking</b></span>
    </a>
  ...
  <div id="dvMain1" class="content-wrapper" >
      <section class="content-header">
      <h1>
        <b>ระบบจองห้อง</b>
        <small>ผังห้องแบบพานอรามา</small>
      </h1>
      <ol class="breadcrumb">
        <input type="button" id="btnBackMain"  class="btn btn-primary"  value="ย้อนกลับ">
      </ol>
    </section>
        
        <section class="content container-fluid">
              <iframe id="frmMain" style="width:100%;height:0px;display:block" scrolling="no"></iframe>
        </section>
