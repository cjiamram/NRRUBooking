...
$mail->addAddress($sendTo, 'Participant');
...
$body.="<tr><td>join url :</td><td>".$res["zoomLink"]."</td></tr>\n";
$body.="<tr><td>ID :</td><td>".$res["id"]."</td></tr>\n";
$body.="<tr><td>Password :</td><td>".$res["password"]."</td></tr>\n";
$body.="</Table>\n";
