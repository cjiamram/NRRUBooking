...
<script src="/roomReserve/toutsider/jsExecute.js"></script>
<script>
 var path='<?php echo $path?>';
 function loadInput(){
      var url="/roomReserve/toutsider/input.php";
...
function displayData(){
    ...
    var url="<?=$rootPath?>/toutsider/displayData.php?tableName="+tableName+"&dbName="+dbName+"&keyWord="+$("#txtSearch").val();
    console.log(url);
    $("#tblDisplay").load(url);
 }
